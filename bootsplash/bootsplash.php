...
$cmd = "gm convert -comment \"id logo deltabg stop\" logo.png logo.png $themepath/images/logo.mng";
exec($cmd);
$cmd = "gm convert -colorspace gray -comment \"id logov deltabg stop\" logov.png logov.png $themepath/images/logov.mng";
exec($cmd);
